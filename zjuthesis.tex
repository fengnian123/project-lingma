...
\documentclass[
    ...
    % Thesis Info
    StudentName     = 高铭健,
    StudentID       = 3210102322,
    AdvisorName     = 何水兵,
    Grade           = 2021,            % only the year, no '级'
    Major           = 计算机科学与技术,
    Department      = 计算机科学与技术学院,
    SubmitDate      = 2024年5月10日,
    MajorFormat     = general,
    ...
    % Title
    Title           = 扩散模型分布式推理优化,
    TitleEng        = {{Accelerating Distributed Diffusion Inference on Commodity 
Through KV Cache Freezing and Adaptive Communication}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
% \titletwolines{基于通信冻结与异步通信优化}{的扩散模型分布式推理框架}
